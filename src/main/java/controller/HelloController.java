...
void linkedGraphOnAction(ActionEvent event) {
    load("linkedGraph.fxml");
}

    @FXML
    void linkedOperationOnAction(ActionEvent event) {
        load("linkedOperation.fxml");
    }
    ...
    void listOperationsOnAction(ActionEvent event) {
        load("listOperations.fxml");
    }

    @FXML
    void matrixGraphOnAction(ActionEvent event) {
        load("matrixGraph.fxml");
    }

    @FXML
    void matrixOperationsOnAction(ActionEvent event) {
        load("matrixOperations.fxml");
    }
